...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
  <px:PXFormView runat="server" ID="CstFormView1" DataSourceID="ds" 
	...
	<px:PXDropDown runat="server" ID="CstPXDropDown1" DataField="OrderType" />
      ...
      <px:PXSelector CommitChanges="True" runat="server" ID="CstPXSelector2" 
        DataField="ServiceID" ></px:PXSelector></Template>
  </px:PXFormView>
</asp:Content>
	...
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Details" AllowAutoHide="false">
		<Levels>
			<px:PXGridLevel DataMember="DetailsView">
				...
				<px:PXGridColumn DataField="ServiceID" Width="140" />
				...
				<px:PXGridColumn DataField="PercentPaid" Width="100" ></px:PXGridColumn>
				<px:PXGridColumn DataField="ARInvoice__DueDate" Width="90" ></px:PXGridColumn>
				<px:PXGridColumn DataField="ARInvoice__CuryDocBal" Width="100" ></px:PXGridColumn></Columns>
			</px:PXGridLevel>
		</Levels>
