...
namespace PhoneRepairShop
{
    ...
    public sealed class InventoryItemExt : PXCacheExtension<PX.Objects.IN.InventoryItem>
    {
        #region UsrTextC
        [PXDBString(8)]
        [PXUIField(DisplayName = "Text C")]
        public string? UsrTextC { get; set; }
        public abstract class usrTextC :
        PX.Data.BQL.BqlString.Field<usrTextC>
        { }
        #endregion
        ...
        #region UsrTextB
        [PXDBString(8)]
        [PXUIField(DisplayName = "Text B")]
        public string? UsrTextB { get; set; }
        public abstract class usrTextB :
        PX.Data.BQL.BqlString.Field<usrTextB>
        { }
        #endregion
    }
}