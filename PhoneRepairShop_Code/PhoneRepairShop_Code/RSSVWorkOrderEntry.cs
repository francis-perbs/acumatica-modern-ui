...
namespace PhoneRepairShop
{
    public class RSSVWorkOrderEntry : PXGraph<RSSVWorkOrderEntry, RSSVWorkOrder>
    {
        ...
        public SelectFrom<RSSVStockItemDevice>.View CompatibleDevices = null!;
        ...
        #region Actions
        public PXAction<RSSVWorkOrder> FullService = null!;
        [PXButton(), PXUIField(DisplayName = "Full")]
        protected virtual IEnumerable fullService(PXAdapter adapter)
        {
            throw new PXRedirectToUrlException("https://www.acumatica.com", "Redirect to Acumatica");
        }

        public PXAction<RSSVWorkOrder> PartialService = null!;
        [PXButton(), PXUIField(DisplayName = "Partial")]
        protected virtual IEnumerable partialService(PXAdapter adapter)
        {
            throw new PXRedirectToUrlException("https://www.acutrive.com", "Redirect to Acutrive");
        }

        public PXAction<RSSVWorkOrder> RecommendService = null!;
        [PXButton(), PXUIField(DisplayName = "Recommend")]
        protected virtual IEnumerable recommendService(PXAdapter adapter)
        {
            throw new PXRedirectToUrlException("https://constructor.tech", "Redirect to Constructor");
        }

        public PXAction<RSSVWorkOrder> GoToGoogle = null!;
        [PXButton(), PXUIField(DisplayName = "Go To Google")]
        protected virtual IEnumerable goToGoogle(PXAdapter adapter)
        {
            throw new PXRedirectToUrlException("https://www.google.com", "Redirect to Google");
        }
        ...
        {
            if (WorkOrders.Current.InvoiceNbr == null) throw new PXException("The invoice has not been created yet.");
            var invoiceEntry = PXGraph.CreateInstance<SOInvoiceEntry>();
            var invoice = invoiceEntry.Document.Search<SOInvoice.refNbr>(WorkOrders.Current.InvoiceNbr);

            invoiceEntry.Document.Current = invoice;
            throw new PXRedirectRequiredException(invoiceEntry, true, nameof(OpenInvoice))
            {
